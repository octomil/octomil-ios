...
public enum SpanAttribute {
    ...
    public static let kvCacheStrategy = "kv_cache.strategy"
    public static let kvCacheQuantizationBits = "kv_cache.quantization_bits"
    public static let kvCacheCompressionRatio = "kv_cache.compression_ratio"
